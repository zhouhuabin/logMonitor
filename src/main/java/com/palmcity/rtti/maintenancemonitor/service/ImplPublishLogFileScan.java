 ...
 *          </table>
 */
public class ImplPublishLogFileScan extends AbstractLogFileScan {

	/**
	 * 构造器 
	 */
	public ImplPublishLogFileScan() {
		super();
		// TODO Auto-generated constructor stub
	}

	public ImplPublishLogFileScan(List<LogFileConfigure> cfList) {
		super(cfList);
	}
