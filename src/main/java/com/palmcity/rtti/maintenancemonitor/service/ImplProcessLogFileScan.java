 ...
 *          </table>
 */
public class ImplProcessLogFileScan extends AbstractLogFileScan {

	/**
	 * 构造器 
	 */
	public ImplProcessLogFileScan() {
		super();
		// TODO Auto-generated constructor stub
	}

	public ImplProcessLogFileScan(List<LogFileConfigure> cfList) {
		super(cfList);
	}
