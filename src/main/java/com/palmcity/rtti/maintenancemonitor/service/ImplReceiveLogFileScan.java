 ...
 *          </table>
 */
public class ImplReceiveLogFileScan extends AbstractLogFileScan {

	
	/**
	 * 构造器 
	 */
	public ImplReceiveLogFileScan() {
		super();
		// TODO Auto-generated constructor stub
	}

	public ImplReceiveLogFileScan(List<LogFileConfigure> cfList) {
		super(cfList);
	}
